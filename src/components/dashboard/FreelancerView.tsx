            ...
            <motion.div key="home" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }} transition={{ duration: 0.28 }} className="space-y-5">
              ...
              <Card className="p-5">
                ...
                <div className="text-center py-6">
                  ...
                  <button onClick={() => setActiveTab("tasks")} className="mt-4 px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest text-blue-700 bg-blue-50 border border-blue-100 hover:bg-blue-100 transition-all">
                    Browse Jobs
                  </button>
                </div>
              </Card>
