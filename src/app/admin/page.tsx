...
export default function AdminPage() {
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-[#020617] text-white selection:bg-red-500/30 font-sans relative">
      ...
      <main className="flex-1 p-6 md:p-16 md:ml-0">
                ...
                <tbody className="divide-y divide-white/5">
                      ...
                      {activeTab === "payments" && (
                        ...
                        <div className="space-y-6 animate-in slide-in-from-right-4">
                          ...
                          <h3 className="text-2xl font-black italic uppercase">Payment <span className="text-red-500">Hub</span></h3>
                      ...
                      {activeTab === "analytics" && (
                        ...
                        <div className="space-y-6 animate-in slide-in-from-right-4">
                          ...
                          <h3 className="text-2xl font-black italic uppercase">Analytics <span className="text-red-500">Engine</span></h3>
                      ...
                      {activeTab === "settings" && (
                        ...
                        <div className="space-y-6 animate-in slide-in-from-right-4">
                          ...
                          <h3 className="text-2xl font-black italic uppercase">System <span className="text-red-500">Settings</span></h3>
